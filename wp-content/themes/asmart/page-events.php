                    ...
                    <div class="news-block">
                        ...
                        if ($the_query->have_posts()) :
                            while ($the_query->have_posts()) :
                                ...
                                $date_end = get_field( 'data_end' ,$post_id);
                                ...
                                <div class="block-news-wrap">
                                        <a href="' . get_the_permalink() . '" title="' . __('ссылка на новость', 'light') . '">
                                            ...
                                            <img src="' . wp_get_attachment_image_src(get_post_thumbnail_id($post_id), 'news-img')[0] . '"
                                        ...
                                        <div class="news-block-content"> 
                                            ...
                                            if(!empty($date_end)){
                                                echo '<p>Мероприятие проходит до: <span>'.$date_end.'</span>  </p>';
                                                $class = '';
                                            }else{
                                                $class = 'class="align-block-right"';
                                            }

                                        echo '<svg  '.$class.'  id="Capa_1" x="0px" y="0px" viewBox="0 0 31.494 31.494" style="enable-background:new 0 0 31.494 31.494;" xml:space="preserve" width="512px" height="512px" class=""><g transform="matrix(-1 1.22465e-16 -1.22465e-16 -1 31.494 31.494)"><path d="M10.273,5.009c0.444-0.444,1.143-0.444,1.587,0c0.429,0.429,0.429,1.143,0,1.571l-8.047,8.047h26.554  c0.619,0,1.127,0.492,1.127,1.111c0,0.619-0.508,1.127-1.127,1.127H3.813l8.047,8.032c0.429,0.444,0.429,1.159,0,1.587  c-0.444,0.444-1.143,0.444-1.587,0l-9.952-9.952c-0.429-0.429-0.429-1.143,0-1.571L10.273,5.009z" data-original="#1E201D" class="active-path" data-old_color="#019be1" fill="#019be1"/></g> </svg>    
                                            </a> 
                                        </div>
