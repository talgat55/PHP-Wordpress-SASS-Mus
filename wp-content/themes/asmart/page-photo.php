                ...
                <div class="start-content">
                    ...
                    <ul class="cat-media">
                        ...
                        if ($the_query->have_posts()) : ?>
                                <div class="list-media   gallery-page">
                                    <div class="row">
                                <?php
                            $i =0;
                            while ($the_query->have_posts()) :
                                ...
                                echo '
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12   ">
                                                <a href="'.  get_the_permalink().'" title="'.__('ссылка на медиа', 'light').'"  style="background: url('. $gallery[0]['url'].') no-repeat!important;  background-size: cover!important;     background-position: center center!important;">
